...
public class Events
{
	...
	public class InputDevice {
		...
		public int SendTouchEvent(int x, int y) {
...
//			intSendEvent(m_nId, 3, 53, 724);
//			intSendEvent(m_nId, 3, 54, 1604);
//			intSendEvent(m_nId, 3, 58, 40);
//			intSendEvent(m_nId, 3, 48, 3);
//			intSendEvent(m_nId, 3, 57, 0);
//			intSendEvent(m_nId, 0, 2, 0);
//			intSendEvent(m_nId, 0, 0, 0);
//			intSendEvent(m_nId, 0, 2, 0);
//			intSendEvent(m_nId, 0, 0, 0);
//			intSendEvent(0, 3, 0, 2);
//			intSendEvent(0, 0, 0, 0);
